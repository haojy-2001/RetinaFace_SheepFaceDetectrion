...
def get_args():
    ...
    parser.add_argument('--epochs', type=int, default=220, help='Max training epochs')
    ...
    parser.add_argument('--eval_step', type=int, default=5, help='Evaluate every eval_step epochs')
...
def main():
    ...
    dataloader_train = DataLoader(dataset_train, num_workers=8, batch_size=args.batch, collate_fn=collater,
                                  shuffle=True)
